...
public class Lightstaff implements GuideBookEntry {
    ...
    public List<Component> getPages() {
        ...
        pages.add(Component.text("To unlock this entry you have to get yourself a ")
                ...
                .append(Component.text(" Chance)\n\n(No treasure water required and only if the player hasn't already an lightstaff in their inventory)", NamedTextColor.GOLD)));
        pages.add(Component.text("Stronghold Crossing", NamedTextColor.GOLD)
                ...
                .append(Component.text(".\n\n\nOnce you have gained your lightstaff you can throw it into the multi-structure which is introduced in the "))
