...
public class dis_book implements Discovery {
    ...
    public ItemStack build() {
        ...
        final Component page2 = GsonComponentSerializer.gson().deserialize("{\"color\":\"dark_purple\",\"extra\":[{\"color\":\"red\",\"text\":\"The Disassambling Table\"}],\"text\":\"I am glad you made it to the second volume of the documentation of Paveralicious Additions. Another structure is described on the following pages:\n\n\"}");
        ...
        final Component page4 = GsonComponentSerializer.gson().deserialize("{\"color\":\"dark_purple\",\"text\":\"the Disassambling Table comes into place. You can use it to take tools apart and learn which materials had been used for the original forming.\n\nThe Blueprint is shown on the following pages.\"}");
        ...
        final Component page7 = GsonComponentSerializer.gson().deserialize("{\"color\":\"dark_purple\",\"text\":\"Throw your item to be disassembled onto the smiting table and place a lever to the side. Flick the lever to start the process. This process cannot be undone or interrupted, so keep an eye out for the resulting materials to reform the item on the altar again.\"}");
